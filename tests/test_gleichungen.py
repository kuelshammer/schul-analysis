...
def test_gleichungsloeser():
    ...
    # TODO: ParametrischeFunktion ist noch nicht implementiert
    print("\n2. ParametrischeFunktion.löse_für_x() - Noch nicht implementiert")
    # print("2. Teste ParametrischeFunktion.löse_für_x()")
    #
