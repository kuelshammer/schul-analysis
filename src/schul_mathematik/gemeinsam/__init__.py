"""
Gemeinsame Basisfunktionalität für alle Module des Schul-Mathematik Frameworks

Enthält gemeinsam genutzte Typ-Definitionen, Fehlerklassen,
...
__all__ = [
    ...
    # Typ-Definitionen und Fehlerklassen werden aus analysis importiert
]
